...
# 13 "MCAL_Layer/HAL_gpio/hal_gpio.h"
# 1 "MCAL_Layer/HAL_gpio/../device_config.h" 1
# 13 "MCAL_Layer/HAL_gpio/hal_gpio.h" 2

# 1 "MCAL_Layer/HAL_gpio/../compiler.h" 1
# 13 "MCAL_Layer/HAL_gpio/../compiler.h"
...
# 13 "MCAL_Layer/HAL_gpio/../compiler.h" 2
# 14 "MCAL_Layer/HAL_gpio/hal_gpio.h" 2

# 1 "MCAL_Layer/HAL_gpio/../std_types.h" 1
# 13 "MCAL_Layer/HAL_gpio/../std_types.h"
# 1 "MCAL_Layer/HAL_gpio/../std_libraries.h" 1
# 11 "MCAL_Layer/HAL_gpio/../std_libraries.h"
...
# 11 "MCAL_Layer/HAL_gpio/../std_libraries.h" 2
# 13 "MCAL_Layer/HAL_gpio/../std_types.h" 2
...
# 35 "MCAL_Layer/HAL_gpio/hal_gpio.h"
typedef enum{
    PORTA_INDEX = 0,
    PORTB_INDEX,
    PORTC_INDEX,
...
Std_ReturnType hal_gpio_pin_init(pin_config_t *pin_config)
{
    ...
    if (pin_config == ((void*)0) || pin_config->pin >= 0x08
            || pin_config->port >= 0x05)
        ret = (Std_ReturnType)0x01;
    else {
        switch (pin_config->direction)
        {
            case (GPIO_OUTPUT):
                (*TRIS[pin_config->port] &= ~(1 << pin_config->pin));
                switch (pin_config->logic){
                    case (OUTPUT_LOGIC_HIGH):
                        (*LAT[pin_config->port] |= (1 << pin_config->pin));
                        break;
...
Std_ReturnType hal_gpio_pin_get_direction(pin_config_t *pin_config)
{
    ...
    if (pin_config == ((void*)0) || pin_config->pin >= 0x08
        ...
        pin_config->direction = ((*TRIS[pin_config->port] >> pin_config->pin) & 1);
...
Std_ReturnType hal_gpio_pin_read(pin_config_t *pin_config, uint8 *output)
{
    ...
    if (pin_config == ((void*)0) || output == ((void*)0)
            || pin_config->pin >= 0x08
            || pin_config->port >= 0x05)
        ret = (Std_ReturnType)0x01;
    else
        *output = ((*PORT[pin_config->port] >> pin_config->pin) & 1);
...
Std_ReturnType hal_gpio_pin_toggle(pin_config_t *pin_config)
{
    ...
    if (pin_config == ((void*)0) || pin_config->pin >= 0x08
        ...
        (*LAT[pin_config->port] ^= (1 << pin_config->pin));
        pin_config->logic = ((*LAT[pin_config->port] >> pin_config->pin) & 1);
    }
